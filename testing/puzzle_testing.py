...
class PuzzleTester:
    def __init__(self, config_path="config.yaml", db_path="puzzles/puzzles.db", log_dir="logging"):
    ...
    def _setup_logger(self):
        ...
        fh = logging.FileHandler(os.path.join(self.log_dir, "puzzle_testing.log"))
